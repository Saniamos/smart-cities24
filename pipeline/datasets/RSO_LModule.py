...
class RSO_LModule(pl.LightningDataModule):
    ...
    def setup(self, stage: str):
        ...
        if stage == "fit":
            d = self._load_datasets(sessions=[1, 2, 3, 4, 5])
            # https://pytorch.org/docs/stable/data.html#torch.utils.data.random_split
            self.train_data, self.val_data = random_split(ConcatDataset(d), [0.9, 0.1], generator=torch.Generator().manual_seed(42))
